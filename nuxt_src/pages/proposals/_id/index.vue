...
export default {
  ...
  head() {
    ...
    return {
      title: title,
      meta: [
        { name: 'og:title', content: `${title} | ScalaMatsuri 2022` },
        { name: 'description', content: `${title} | ScalaMatsuri 2022` },
        { property: 'og:title', content: `${title} | ScalaMatsuri 2022` },
        { property: 'og:description', content: `${this.program[this.$i18n.locale].detail}` },
        { name: 'twitter:title', content: `${title} | ScalaMatsuri 2022` },
