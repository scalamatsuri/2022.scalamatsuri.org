...
en:
  ...
  body_01: |
    Here are some notes to ScalaMatsuri speakers.
...
ja:
  title_01: スピーカーの皆さんへ
  body_01: |
    ScalaMatsuri スピーカーの皆さんへの連絡事項です。
  title_02: 時間厳守
  body_02: |
  ...
  body_05: |
    ScalaMatsuri 2022終了後、Webサイトにスライドと動画のリンクを追記する予定です。<br>
...
export default {
  head() {
    ...
    return {
      title: $t('title_01'),
      meta: [
        { name: 'og:title', content: `${$t('title_01')} | ScalaMatsuri 2022` }
      ]
    }
  }
}
