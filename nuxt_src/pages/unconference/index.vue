...
en:
  ...
  day2_flow_text_01: |
    We will prepare <a href="https://github.com/scalamatsuri/2022.open-mic-conference" target="_blank" rel="noopener">a GitHub repository to gather session ideas</a> beforehand.
    <br>
    Please create <a href="https://github.com/scalamatsuri/2022.open-mic-conference/issues" target="_blank" rel="noopener">GitHub issues</a> to put your session ideas.
    <br><br>
    ...
    <br><br>
    Once <a href="https://github.com/scalamatsuri/2022.open-mic-conference/projects/1" target="_blank" rel="noopener">the timetable</a> is decided, the Open mic conference starts.
    <br><br>
...
ja:
  ...
  day2_flow_text_01: |
    ScalaMatsuri 2022では、<a href="https://github.com/scalamatsuri/2022.open-mic-conference" target="_blank" rel="noopener">ネタを募集するGitHubリポジトリ</a>を用意します。
    <br><br>
    思い思いにセッションのアイディアを<a href="https://github.com/scalamatsuri/2022.open-mic-conference/issues" target="_blank" rel="noopener">GitHub issue</a>に書いて下さい。
    <br><br>
    飛び入りカンファレンスDAYに「朝会」を行い、集まったネタを元にセッションの決定とタイムテーブルの作成を行います。
    <br><br>
    <a href="https://github.com/scalamatsuri/2022.open-mic-conference/projects/1" target="_blank" rel="noopener">タイムテーブル</a>が決まったら、飛び入りカンファレンス開始です。
    <br><br>
